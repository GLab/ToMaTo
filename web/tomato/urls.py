...
urlpatterns = patterns('',
    ...
    (r'^dumpmanager/hide_older_than/(?P<border_time>[1-90]+.?[1-90]*)_days$', 'tomato.dumpmanager.hide_old_errorgroups'),
    (r'^dumpmanager/remove_older_than/(?P<border_time>[1-90]+.?[1-90]*)_days$', 'tomato.dumpmanager.remove_old_errorgroups'),
