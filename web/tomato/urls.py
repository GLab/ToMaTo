...
urlpatterns = patterns('',
	...
	(r'^account$', 'tomato.account.info_or_register'),	
	...
	(r'^templates/edit/data$', 'tomato.vhosttemplates.edit_data'),
	(r'^templates/edit/torrent$', 'tomato.vhosttemplates.edit_torrent'),
	...
	(r'^profiles/edit/kvmqm$', 'tomato.device_profile.edit_kvmqm'),
	(r'^profiles/edit/openvz$', 'tomato.device_profile.edit_openvz'),
	(r'^profiles/edit/repy$', 'tomato.device_profile.edit_repy'),
