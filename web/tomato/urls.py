...
urlpatterns = patterns('',
    ...
    (r'^link_stats/(?P<site>[^/]+)$', 'tomato.site_map.details_site'),
    ...
    url(r'^organization/(?P<organization>[^/]+)/hosts$', 'tomato.admin.host.list', name="organization_hosts"),
    url(r'^site/(?P<site>[^/]+)/hosts$', 'tomato.admin.host.list', name="site_hosts"),
    (r'^host/add$', 'tomato.admin.host.add'),
    (r'^host/add/(?P<site>[^/]+)$', 'tomato.admin.host.add'),
    ...
    (r'^organization/(?P<name>[^/]+)$', 'tomato.admin.organization.info'),
    (r'^organization/(?P<name>[^/]+)/edit$', 'tomato.admin.organization.edit'),
    (r'^organization/edit$', 'tomato.admin.organization.edit'),
    (r'^organization/(?P<name>[^/]+)/remove$', 'tomato.admin.organization.remove'),
    (r'^organization/(?P<name>[^/]+)/usage$', 'tomato.usage.organization'),
    (r'^organization/(?P<organization>[^/]+)/add_site$', 'tomato.admin.site.add'),
    (r'^site/$', 'tomato.admin.site.list'),
    (r'^site/add$', 'tomato.admin.site.add'),
    (r'^site/(?P<name>[^/]+)/edit$', 'tomato.admin.site.edit'),
    (r'^site/edit$', 'tomato.admin.site.edit'),
    (r'^site/(?P<name>[^/]+)/info$', 'tomato.admin.site.info'),
    (r'^site/(?P<name>[^/]+)/remove$', 'tomato.admin.site.remove'),
