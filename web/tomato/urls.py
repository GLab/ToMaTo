...
urlpatterns = patterns('',
	...
	url(r'^account/notification/(?P<notification_id>\w+)/mark-read$', 'tomato.account.notification_mark_read', {'read': True}, name="notification_mark_read"),
	url(r'^account/notification/(?P<notification_id>\w+)/mark-unread$', 'tomato.account.notification_mark_read', {'read': False}, name="notification_mark_unread"),
