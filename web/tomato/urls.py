...
urlpatterns = patterns('',
	...
	(r'^account/remove/$', 'tomato.account.remove'),
	(r'^account/remove/(?P<username>.*)$', 'tomato.account.remove'),	
	...
	(r'^map/$', 'tomato.physical_link_stats.index'),
	(r'^map.kml$', 'tomato.physical_link_stats.kml'),
	...
	(r'^site/edit/(?P<name>\w+)$', 'tomato.site.edit'),
	(r'^site/remove/$', 'tomato.site.remove'),
	(r'^site/remove/(?P<name>\w+)$', 'tomato.site.remove'),
	(r'^organization/$', 'tomato.organization.index'),
	(r'^organization/add$', 'tomato.organization.add'),
	(r'^organization/edit/$', 'tomato.organization.edit'),
	(r'^organization/edit/(?P<name>\w+)$', 'tomato.organization.edit'),
	(r'^organization/remove/$', 'tomato.organization.remove'),
	(r'^organization/remove/(?P<name>\w+)$', 'tomato.organization.remove'),
	...
	(r'^templates/edit/(?P<res_id>\d+)$', 'tomato.device_templates.edit'),
	(r'^templates/edit/data$', 'tomato.device_templates.edit_data'),
	(r'^templates/edit/(?P<res_id>\d+)/data$', 'tomato.device_templates.edit_data'),
	(r'^templates/edit/torrent$', 'tomato.device_templates.edit_torrent'),
	(r'^templates/edit/(?P<res_id>\d+)/torrent$', 'tomato.device_templates.edit_torrent'),
	(r'^templates/remove/$', 'tomato.device_templates.remove'),
	(r'^templates/remove/(?P<res_id>\d+)$', 'tomato.device_templates.remove'),
	(r'^profiles/$', 'tomato.device_profile.index'),
	(r'^profiles/add/$', 'tomato.device_profile.add'),
	(r'^profiles/edit/$', 'tomato.device_profile.edit'),
	(r'^profiles/edit/(?P<res_id>\d+)$', 'tomato.device_profile.edit'),
	(r'^profiles/remove/$', 'tomato.device_profile.remove'),
	(r'^profiles/remove/(?P<res_id>\d+)$', 'tomato.device_profile.remove'),
	...
	(r'^external_networks/edit/(?P<res_id>\d+)$', 'tomato.external_networks.edit'),
	(r'^external_networks/remove/$', 'tomato.external_networks.remove'),
	(r'^external_networks/remove/(?P<res_id>\d+)$', 'tomato.external_networks.remove'),
