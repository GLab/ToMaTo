...
var Workspace = Class.extend({
	init: function(container, editor) {
    	...
    	this.tutorialStatus = 3;
    	this.tutorialSentences = [
    	
    		//0
    		"Welcome to ToMaTo!. You have just created a new Topology.\n\
    		...
    		//4
    		"You have connected the two devices."
	...
	updateTutorialBar: function() {
		...
		var text = this.tutorialSentences[this.tutorialStatus];
