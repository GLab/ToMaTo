...
class TemplateForm(BootstrapForm):
	...
	preference = forms.IntegerField(label="Preference", help_text="Sort templates in the editor (higher preference first). When preference &ge; 100, the template will be featured as 'Common Element' in the editor's home tab. Must be an integer number.")
