...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UsageStatistics.begin'
        db.add_column('tomato_usagestatistics', 'begin', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 9, 4, 10, 10, 51, 493569), blank=True), keep_default=False)
