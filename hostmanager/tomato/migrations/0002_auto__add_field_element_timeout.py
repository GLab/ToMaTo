...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Element.timeout'
        db.add_column('tomato_element', 'timeout', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Element.timeout'
        db.delete_column('tomato_element', 'timeout')
