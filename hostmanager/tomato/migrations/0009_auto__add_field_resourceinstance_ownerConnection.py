...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResourceInstance.ownerConnection'
        db.add_column('tomato_resourceinstance', 'ownerConnection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Connection'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResourceInstance.ownerConnection'
        db.delete_column('tomato_resourceinstance', 'ownerConnection_id')
