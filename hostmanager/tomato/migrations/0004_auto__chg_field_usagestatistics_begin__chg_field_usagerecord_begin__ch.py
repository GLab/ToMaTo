...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UsageStatistics.begin'
        db.alter_column('tomato_usagestatistics', 'begin', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'UsageRecord.begin'
        db.alter_column('tomato_usagerecord', 'begin', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'UsageRecord.end'
        db.alter_column('tomato_usagerecord', 'end', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'UsageStatistics.begin'
        db.alter_column('tomato_usagestatistics', 'begin', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'UsageRecord.begin'
        db.alter_column('tomato_usagerecord', 'begin', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'UsageRecord.end'
        db.alter_column('tomato_usagerecord', 'end', self.gf('django.db.models.fields.DateTimeField')())
