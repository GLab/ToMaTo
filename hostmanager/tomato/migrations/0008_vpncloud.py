...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VpnCloud'
        db.create_table('tomato_vpncloud', (
            (u'element_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tomato.Element'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('tomato', ['VpnCloud'])


    def backwards(self, orm):
        # Deleting model 'VpnCloud'
        db.delete_table('tomato_vpncloud')
    ...
    models = {
        ...
        'tomato.vpncloud': {
            'Meta': {'object_name': 'VpnCloud', '_ormbases': [u'tomato.Element']},
            u'element_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tomato.Element']", 'unique': 'True', 'primary_key': 'True'})
        }
    }
