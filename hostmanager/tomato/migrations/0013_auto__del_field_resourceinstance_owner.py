...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ResourceInstance.owner'
        db.delete_column('tomato_resourceinstance', 'owner_id')


    def backwards(self, orm):
        
        # Adding field 'ResourceInstance.owner'
        db.add_column('tomato_resourceinstance', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dummy', null=True, to=orm['tomato.Element']), keep_default=False)
