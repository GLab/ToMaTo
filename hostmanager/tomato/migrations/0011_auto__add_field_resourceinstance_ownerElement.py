...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResourceInstance.ownerElement'
        db.add_column('tomato_resourceinstance', 'ownerElement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Element'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResourceInstance.ownerElement'
        db.delete_column('tomato_resourceinstance', 'ownerElement_id')
    ...
    models = {
        ...
        'tomato.resourceinstance': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dummy'", 'null': 'True', 'to': "orm['tomato.Element']"}),
