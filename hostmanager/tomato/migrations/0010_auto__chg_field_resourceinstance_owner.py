...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResourceInstance.owner'
        db.alter_column('tomato_resourceinstance', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Element'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ResourceInstance.owner'
        raise RuntimeError("Cannot reverse this migration. 'ResourceInstance.owner' and its values cannot be restored.")
    ...
    models = {
        ...
        'tomato.resourceinstance': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tomato.Element']", 'null': 'True'}),
