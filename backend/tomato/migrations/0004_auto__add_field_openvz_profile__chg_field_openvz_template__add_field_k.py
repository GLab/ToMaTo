...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenVZ.profile'
        db.add_column('tomato_openvz', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Profile'], null=True), keep_default=False)
        ...
        # Adding field 'KVMQM.profile'
        db.add_column('tomato_kvmqm', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Profile'], null=True), keep_default=False)
        ...
        # Adding field 'Repy.profile'
        db.add_column('tomato_repy', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Profile'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'OpenVZ.profile'
        db.delete_column('tomato_openvz', 'profile_id')
        ...
        # Deleting field 'KVMQM.profile'
        db.delete_column('tomato_kvmqm', 'profile_id')

        # Changing field 'KVMQM.template'
        db.alter_column('tomato_kvmqm', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Resource'], null=True))

        # Deleting field 'Repy.profile'
        db.delete_column('tomato_repy', 'profile_id')

        # Changing field 'Repy.template'
        db.alter_column('tomato_repy', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Resource'], null=True))
