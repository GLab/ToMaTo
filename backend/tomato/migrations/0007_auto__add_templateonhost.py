...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TemplateOnHost'
        db.create_table('tomato_templateonhost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(related_name='templates', to=orm['tomato.Host'])),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hosts', to=orm['tomato.Template'])),
            ('ready', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('tomato', ['TemplateOnHost'])


    def backwards(self, orm):
        
        # Deleting model 'TemplateOnHost'
        db.delete_table('tomato_templateonhost')
    ...
    models = {
        ...
        'tomato.templateonhost': {
            'Meta': {'object_name': 'TemplateOnHost'},
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1365149887.857207'}),
