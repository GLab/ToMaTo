...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Permission.user'
        db.add_column('tomato_permission', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.User'], null=True), keep_default=False)

        # Adding field 'Topology.owner'
        db.add_column('tomato_topology', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.User'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Permission.user'
        db.delete_column('tomato_permission', 'user_id')

        # Deleting field 'Topology.owner'
        db.delete_column('tomato_topology', 'owner_id')
    ...
    models = {
        ...
        'tomato.permission': {
            ...
            'topology': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tomato.Topology']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tomato.User']", 'null': 'True'}),
        ...
        'tomato.topology': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tomato.User']", 'null': 'True'}),
