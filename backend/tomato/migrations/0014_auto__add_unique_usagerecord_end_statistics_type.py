...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UsageRecord', fields ['end', 'statistics', 'type']
        db.create_unique('tomato_usagerecord', ['end', 'statistics_id', 'type'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UsageRecord', fields ['end', 'statistics', 'type']
        db.delete_unique('tomato_usagerecord', ['end', 'statistics_id', 'type'])
