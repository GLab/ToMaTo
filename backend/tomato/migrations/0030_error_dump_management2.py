...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ErrorDump.attrs'
        db.add_column('tomato_errordump', 'attrs',
                      self.gf('tomato.lib.db.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ErrorDump.attrs'
        db.delete_column('tomato_errordump', 'attrs')
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1407272859.989164'}),
