...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Error.date'
        db.delete_column('tomato_error', 'date')

        # Adding field 'Error.date_first'
        db.add_column('tomato_error', 'date_first', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 8, 15), blank=True), keep_default=False)

        # Adding field 'Error.occurrences'
        db.add_column('tomato_error', 'occurrences', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Error.type'
        db.add_column('tomato_error', 'type', self.gf('django.db.models.fields.CharField')(default='error', max_length=20), keep_default=False)

        # Adding field 'Error.date_last'
        db.add_column('tomato_error', 'date_last', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 8, 15), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Error.date'
        db.add_column('tomato_error', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 8, 15), blank=True), keep_default=False)

        # Deleting field 'Error.date_first'
        db.delete_column('tomato_error', 'date_first')

        # Deleting field 'Error.occurrences'
        db.delete_column('tomato_error', 'occurrences')

        # Deleting field 'Error.type'
        db.delete_column('tomato_error', 'type')

        # Deleting field 'Error.date_last'
        db.delete_column('tomato_error', 'date_last')
