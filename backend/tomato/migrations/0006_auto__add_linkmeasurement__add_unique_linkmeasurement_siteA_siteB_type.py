...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LinkMeasurement'
        db.create_table('tomato_linkmeasurement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('siteA', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['tomato.Site'])),
            ('siteB', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['tomato.Site'])),
            ...
            ('delayAvg', self.gf('django.db.models.fields.FloatField')()),
            ('delayStddev', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('tomato', ['LinkMeasurement'])

        # Adding unique constraint on 'LinkMeasurement', fields ['siteA', 'siteB', 'type', 'end']
        db.create_unique('tomato_linkmeasurement', ['siteA_id', 'siteB_id', 'type', 'end'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'LinkMeasurement', fields ['siteA', 'siteB', 'type', 'end']
        db.delete_unique('tomato_linkmeasurement', ['siteA_id', 'siteB_id', 'type', 'end'])

        # Deleting model 'LinkMeasurement'
        db.delete_table('tomato_linkmeasurement')
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1361458475.207709'}),
