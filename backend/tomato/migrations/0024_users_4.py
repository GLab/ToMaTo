...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Permission.user_name'
        db.delete_column('tomato_permission', 'user_name')
        ...
        # Deleting field 'Topology.owner_name'
        db.delete_column('tomato_topology', 'owner_name')

        # Changing field 'Topology.owner'
        db.alter_column('tomato_topology', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.User']))
    
    
    def backwards(self, orm):
        
        # Adding field 'Permission.user_name'
        db.add_column('tomato_permission', 'user_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Changing field 'Permission.user'
        db.alter_column('tomato_permission', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.User'], null=True))

        # Adding unique constraint on 'Permission', fields ['user_name', 'topology']
        db.create_unique('tomato_permission', ['user_name', 'topology_id'])

        # Removing unique constraint on 'Permission', fields ['user', 'topology']
        db.delete_unique('tomato_permission', ['user_id', 'topology_id'])

        # Adding field 'Topology.owner_name'
        db.add_column('tomato_topology', 'owner_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Changing field 'Topology.owner'
        db.alter_column('tomato_topology', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.User'], null=True))
