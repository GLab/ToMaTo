...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.totalUsage'
        db.add_column('tomato_organization', 'totalUsage', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, null=True, to=orm['tomato.UsageStatistics']), keep_default=False)

        # Adding field 'User.totalUsage'
        db.add_column('tomato_user', 'totalUsage', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, null=True, to=orm['tomato.UsageStatistics']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.totalUsage'
        db.delete_column('tomato_organization', 'totalUsage_id')

        # Deleting field 'User.totalUsage'
        db.delete_column('tomato_user', 'totalUsage_id')
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1396857758.701831'}),
