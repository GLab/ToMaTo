...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interface.name'
        db.alter_column('tomato_interface', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
    
    
    def backwards(self, orm):
        
        # Changing field 'Interface.name'
        db.alter_column('tomato_interface', 'name', self.gf('django.db.models.fields.CharField')(max_length=5))
