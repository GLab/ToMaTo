...
substitutions = [('admin', 'global_admin'),
				 ...
				 ('global_owner', 'global_topl_owner'),
				 ('global_manager', 'global_topl_manager'),
				 ('global_owner', 'global_topl_user'),
				 ('hosts_contact', 'global_host_contact'),
				 ('admin_contact', 'global_admin_contact')]
...
class Migration(DataMigration):
	...
	models = {
		...
		'tomato.user': {
			...
			'attrs': ('tomato.lib.db.JSONField', [], {}),
			'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
			'last_login': ('django.db.models.fields.FloatField', [], {'default': '1385461815.456511'}),
