...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('device_profile', (
        ...
        db.send_create_signal('tomato', ['DeviceProfile'])

        # Adding unique constraint on 'DeviceProfile', fields ['name', 'type']
        db.create_unique('device_profile', ['name', 'type'])

        # Adding field 'Device.profile'
        db.add_column('tomato_device', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.DeviceProfile'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'DeviceProfile', fields ['name', 'type']
        db.delete_unique('device_profile', ['name', 'type'])

        # Deleting model 'DeviceProfile'
        db.delete_table('device_profile')

        # Deleting field 'Device.profile'
        db.delete_column('tomato_device', 'profile_id')
