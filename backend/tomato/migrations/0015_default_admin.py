# encoding: utf-8
import datetime, crypt, time, json
...
class Migration(DataMigration):
	...
	def forwards(self, orm):
		...
		if Users.objects.count() == 0:
			Users.objects.create(
				...
				password=crypt.crypt("changeme", "$1$12345678"),
				password_time=time.time(),
				attrs=json.dumps({
					"realname": "Initial administrator",
					"email": "mail@example.com",
					"flags": ["global_admin", "global_host_manager"] 
				})
			)
			print "Added initial account, admin:changeme"
	...
	models = {
		...
		'tomato.user': {
			...
			'attrs': ('tomato.lib.db.JSONField', [], {}),
			'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
			'last_login': ('django.db.models.fields.FloatField', [], {'default': '1385548864.146477'}),
