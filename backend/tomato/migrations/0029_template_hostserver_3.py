...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Template.download_url'
        db.delete_column('tomato_template', 'download_url')
    
    
    def backwards(self, orm):
        
        # Adding field 'Template.download_url'
        db.add_column('tomato_template', 'download_url', self.gf('django.db.models.fields.CharField')(default='http://example.com', max_length=255), keep_default=False)
