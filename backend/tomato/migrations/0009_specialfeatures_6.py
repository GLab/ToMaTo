...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SpecialFeature.feature_type'
        db.delete_column('tomato_specialfeature', 'feature_type')

        # Deleting field 'SpecialFeature.feature_group_name'
        db.delete_column('tomato_specialfeature', 'feature_group_name')

        # Changing field 'SpecialFeature.feature_group'
        db.alter_column('tomato_specialfeature', 'feature_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.SpecialFeatureGroup']))
    
    
    def backwards(self, orm):
        
        # Adding field 'SpecialFeature.feature_type'
        db.add_column('tomato_specialfeature', 'feature_type', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'SpecialFeature.feature_group_name'
        db.add_column('tomato_specialfeature', 'feature_group_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Changing field 'SpecialFeature.feature_group'
        db.alter_column('tomato_specialfeature', 'feature_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.SpecialFeatureGroup'], null=True))
