...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ExternalNetworkBridge', fields ['bridge', 'host']
        db.create_unique('tomato_externalnetworkbridge', ['bridge', 'host_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'ExternalNetworkBridge', fields ['bridge', 'host']
        db.delete_unique('tomato_externalnetworkbridge', ['bridge', 'host_id'])
