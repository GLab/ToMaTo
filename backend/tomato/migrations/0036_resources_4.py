...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		db.rename_column('tomato_tincconnection', 'tinc_port_ref_id', 'tinc_port_id')
		db.rename_column('tomato_tincconnection', 'bridge_id_ref_id', 'bridge_id_id')
		db.rename_column('tomato_kvmdevice', 'vmid_ref_id', 'vmid_id')
		db.rename_column('tomato_kvmdevice', 'vnc_port_ref_id', 'vnc_port_id')
		db.rename_column('tomato_openvzdevice', 'vmid_ref_id', 'vmid_id')
		db.rename_column('tomato_openvzdevice', 'vnc_port_ref_id', 'vnc_port_id')
		db.rename_column('tomato_progdevice', 'vnc_port_ref_id', 'vnc_port_id')
	
	def backwards(self, orm):
		db.rename_column('tomato_tincconnection', 'tinc_port_id', 'tinc_port_ref_id')
		db.rename_column('tomato_tincconnection', 'bridge_id_id', 'bridge_id_ref_id')
		db.rename_column('tomato_kvmdevice', 'vmid_id', 'vmid_ref_id')
		db.rename_column('tomato_kvmdevice', 'vnc_port_id', 'vnc_port_ref_id')
		db.rename_column('tomato_openvzdevice', 'vmid_id', 'vmid_ref_id')
		db.rename_column('tomato_openvzdevice', 'vnc_port_id', 'vnc_port_ref_id')
		db.rename_column('tomato_progdevice', 'vnc_port_id', 'vnc_port_ref_id')
