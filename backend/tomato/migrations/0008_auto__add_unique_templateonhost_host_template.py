...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'TemplateOnHost', fields ['host', 'template']
        db.create_unique('tomato_templateonhost', ['host_id', 'template_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TemplateOnHost', fields ['host', 'template']
        db.delete_unique('tomato_templateonhost', ['host_id', 'template_id'])
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1365151121.163941'}),
