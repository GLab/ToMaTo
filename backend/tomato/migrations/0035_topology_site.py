...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topology.site'
        db.add_column(u'tomato_topology', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.Site'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topology.site'
        db.delete_column(u'tomato_topology', 'site_id')
    ...
    models = {
        ...
        u'tomato.errordump': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dumps'", 'to': u"orm['tomato.ErrorGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1414763272.476557'}),
            ...
            'quota': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['tomato.Quota']"}),
