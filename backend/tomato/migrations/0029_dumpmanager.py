...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tomato_errorgroup', (
            ('group_id', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('tomato', ['ErrorGroup'])

        # Adding model 'ErrorDump'
        db.create_table('tomato_errordump', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('dump_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dumps', to=orm['tomato.ErrorGroup'])),
            ('description', self.gf('tomato.lib.db.JSONField')()),
        ))
        db.send_create_signal('tomato', ['ErrorDump'])

        # Adding unique constraint on 'ErrorDump', fields ['source', 'dump_id']
        db.create_unique('tomato_errordump', ['source', 'dump_id'])



    def backwards(self, orm):
        # Removing unique constraint on 'ErrorDump', fields ['source', 'dump_id']
        db.delete_unique('tomato_errordump', ['source', 'dump_id'])

        # Deleting model 'ErrorGroup'
        db.delete_table('tomato_errorgroup')

        # Deleting model 'ErrorDump'
        db.delete_table('tomato_errordump')
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1407247198.995076'}),
            ...
            'quota': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['tomato.Quota']"}),
