...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Connection.totalUsage'
        db.add_column('tomato_connection', 'totalUsage', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, null=True, to=orm['tomato.UsageStatistics']), keep_default=False)
        ...
        # Deleting field 'UsageStatistics.begin'
        db.delete_column('tomato_usagestatistics', 'begin')

        # Adding field 'Topology.totalUsage'
        db.add_column('tomato_topology', 'totalUsage', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, null=True, to=orm['tomato.UsageStatistics']), keep_default=False)
        ...
        # Adding field 'Element.totalUsage'
        db.add_column('tomato_element', 'totalUsage', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, null=True, to=orm['tomato.UsageStatistics']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Connection.totalUsage'
        db.delete_column('tomato_connection', 'totalUsage_id')

        # Deleting field 'Connection.oldUsage'
        db.delete_column('tomato_connection', 'oldUsage_id')

        # User chose to not deal with backwards NULL issues for 'UsageStatistics.begin'
        raise RuntimeError("Cannot reverse this migration. 'UsageStatistics.begin' and its values cannot be restored.")

        # Deleting field 'Topology.totalUsage'
        db.delete_column('tomato_topology', 'totalUsage_id')

        # Deleting field 'Topology.oldUsage'
        db.delete_column('tomato_topology', 'oldUsage_id')

        # Deleting field 'Element.totalUsage'
        db.delete_column('tomato_element', 'totalUsage_id')
    ...
    models = {
        'tomato.connection': {
            ...
            'oldUsage': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'null': 'True', 'to': "orm['tomato.UsageStatistics']"}),
