...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Host', fields ['rpcurl']
        db.create_unique(u'tomato_host', ['rpcurl'])


    def backwards(self, orm):
        # Removing unique constraint on 'Host', fields ['rpcurl']
        db.delete_unique(u'tomato_host', ['rpcurl'])
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1406191677.998233'}),
