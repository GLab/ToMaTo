...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('tomato_site', 'description')

        # Adding field 'Site.attrs'
        db.add_column('tomato_site', 'attrs', self.gf('tomato.lib.db.JSONField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Site.description'
        raise RuntimeError("Cannot reverse this migration. 'Site.description' and its values cannot be restored.")

        # Deleting field 'Site.attrs'
        db.delete_column('tomato_site', 'attrs')
