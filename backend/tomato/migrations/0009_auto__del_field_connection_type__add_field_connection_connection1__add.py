...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Connection.type'
        db.delete_column('tomato_connection', 'type')

        # Adding field 'Connection.connection1'
        db.add_column('tomato_connection', 'connection1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['tomato.HostConnection']), keep_default=False)

        # Adding field 'Connection.connection2'
        db.add_column('tomato_connection', 'connection2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['tomato.HostConnection']), keep_default=False)

        # Adding field 'Connection.connectionElement1'
        db.add_column('tomato_connection', 'connectionElement1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['tomato.HostElement']), keep_default=False)

        # Adding field 'Connection.connectionElement2'
        db.add_column('tomato_connection', 'connectionElement2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['tomato.HostElement']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Connection.type'
        raise RuntimeError("Cannot reverse this migration. 'Connection.type' and its values cannot be restored.")

        # Deleting field 'Connection.connection1'
        db.delete_column('tomato_connection', 'connection1_id')

        # Deleting field 'Connection.connection2'
        db.delete_column('tomato_connection', 'connection2_id')

        # Deleting field 'Connection.connectionElement1'
        db.delete_column('tomato_connection', 'connectionElement1_id')

        # Deleting field 'Connection.connectionElement2'
        db.delete_column('tomato_connection', 'connectionElement2_id')
