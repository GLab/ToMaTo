...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProgDevice.vnc_port'
        db.delete_column('tomato_progdevice', 'vnc_port')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ProgDevice.vnc_port'
        db.add_column('tomato_progdevice', 'vnc_port', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)
