...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tomato_user', 'password', self.gf('django.db.models.fields.CharField')(max_length=250, null=True), keep_default=False)

        # Adding field 'User.password_time'
        db.add_column('tomato_user', 'password_time', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding unique constraint on 'User', fields ['origin', 'name']
        db.create_unique('tomato_user', ['origin', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'User', fields ['origin', 'name']
        db.delete_unique('tomato_user', ['origin', 'name'])

        # Deleting field 'User.password'
        db.delete_column('tomato_user', 'password')

        # Deleting field 'User.password_time'
        db.delete_column('tomato_user', 'password_time')
