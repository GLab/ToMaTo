...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Host.totalUsage'
        db.add_column('tomato_host', 'totalUsage', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, null=True, to=orm['tomato.UsageStatistics']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Host.totalUsage'
        db.delete_column('tomato_host', 'totalUsage_id')
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1396859008.108463'}),
