...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProgDevice'
        db.create_table('tomato_progdevice', (
            ('device_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tomato.Device'], unique=True, primary_key=True)),
            ('template', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('vnc_port', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
        ))
        db.send_create_signal('tomato', ['ProgDevice'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ProgDevice'
        db.delete_table('tomato_progdevice')
