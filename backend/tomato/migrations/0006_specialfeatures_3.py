...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SpecialFeatureGroup'
        db.create_table('tomato_specialfeaturegroup', (
            ('max_devices', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('group_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('avoid_duplicates', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feature_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('tomato', ['SpecialFeatureGroup'])

        # Deleting field 'SpecialFeature.feature_group'
        db.delete_column('tomato_specialfeature', 'feature_group')
    
    
    def backwards(self, orm):
        
        # Deleting model 'SpecialFeatureGroup'
        db.delete_table('tomato_specialfeaturegroup')

        # Adding field 'SpecialFeature.feature_group'
        db.add_column('tomato_specialfeature', 'feature_group', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'tomato.specialfeature': {
            ...
            'feature_group_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
