...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Network', fields ['kind']
        db.create_unique('tomato_network', ['kind'])

        # Adding field 'NetworkInstance.bridge'
        db.add_column('tomato_network_instance', 'bridge', self.gf('django.db.models.fields.CharField')(default='internet', max_length=20), keep_default=False)

        # Adding unique constraint on 'NetworkInstance', fields ['bridge', 'host']
        db.create_unique('tomato_network_instance', ['bridge', 'host_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'NetworkInstance', fields ['bridge', 'host']
        db.delete_unique('tomato_network_instance', ['bridge', 'host_id'])

        # Removing unique constraint on 'Network', fields ['kind']
        db.delete_unique('tomato_network', ['kind'])

        # Deleting field 'NetworkInstance.bridge'
        db.delete_column('tomato_network_instance', 'bridge')
