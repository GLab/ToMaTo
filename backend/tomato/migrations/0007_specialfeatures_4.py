...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tomato_specialfeature', 'feature_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.SpecialFeatureGroup'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SpecialFeature.feature_group'
        db.delete_column('tomato_specialfeature', 'feature_group_id')
