...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tomato_host', 'name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=255))

        # Adding unique constraint on 'Host', fields ['name']
        db.create_unique('tomato_host', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Host', fields ['name']
        db.delete_unique('tomato_host', ['name'])

        # Changing field 'Host.name'
        db.alter_column('tomato_host', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1392975515.970793'}),
