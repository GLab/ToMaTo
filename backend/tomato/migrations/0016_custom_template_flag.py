...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HostElement.custom_template'
        db.add_column('tomato_hostelement', 'custom_template',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HostElement.custom_template'
        db.delete_column('tomato_hostelement', 'custom_template')
    ...
    models = {
        ...
        'tomato.hostelement': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'custom_template': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1389014014.344963'}),
