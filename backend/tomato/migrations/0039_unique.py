...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Adding field 'TincConnector.mode'
		db.create_unique('tomato_user', ['name', 'origin'])
		db.create_unique('tomato_resourceentry', ['pool_id', 'num'])
		db.create_unique('tomato_resourceentry', ['owner_type', 'owner_id', 'slot'])
		db.create_unique('tomato_resourcepool', ['host_id', 'type'])
	
	
	def backwards(self, orm):
		
		# Deleting field 'TincConnector.mode'
		db.delete_unique('tomato_user', ['name', 'origin'])
		db.delete_unique('tomato_resourceentry', ['pool_id', 'num'])
		db.delete_unique('tomato_resourceentry', ['owner_type', 'owner_id', 'slot'])
		db.delete_unique('tomato_resourcepool', ['host_id', 'type'])
