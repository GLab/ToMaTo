...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'UsageRecord', fields ['end']
        db.create_index('tomato_usagerecord', ['end'])

        # Adding index on 'UsageRecord', fields ['type']
        db.create_index('tomato_usagerecord', ['type'])


    def backwards(self, orm):
        
        # Removing index on 'UsageRecord', fields ['type']
        db.delete_index('tomato_usagerecord', ['type'])

        # Removing index on 'UsageRecord', fields ['end']
        db.delete_index('tomato_usagerecord', ['end'])
