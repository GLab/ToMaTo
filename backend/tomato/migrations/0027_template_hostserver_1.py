...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Template.attrs'
        db.add_column('tomato_template', 'attrs', self.gf('tomato.lib.db.JSONField')(default={}), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Template.attrs'
        db.delete_column('tomato_template', 'attrs')
