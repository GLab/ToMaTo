...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for host in orm['tomato.host'].objects.all():
            host.rpcurl = "https+xmlrpc://%s:8000" % host.address
            host.save()
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1406190938.977774'}),
