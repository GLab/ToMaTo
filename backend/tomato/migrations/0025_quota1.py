...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Usage'
        db.create_table('tomato_usage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('memory', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('diskspace', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('traffic', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('cputime', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ))
        db.send_create_signal('tomato', ['Usage'])

        # Adding field 'UsageRecord.usage'
        db.add_column('tomato_usagerecord', 'usage', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['tomato.Usage']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tomato_usage')

        # Deleting field 'UsageRecord.usage'
        db.delete_column('tomato_usagerecord', 'usage_id')
    ...
    models = {
        ...
        'tomato.usagerecord': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '10', 'db_index': 'True'}),
            'usage': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['tomato.Usage']"})
        },
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1397208030.776444'}),
