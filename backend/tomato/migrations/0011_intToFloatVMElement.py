...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OpenVZ.rextfv_last_started'
        db.alter_column('tomato_openvz', 'rextfv_last_started', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'OpenVZ.next_sync'
        db.alter_column('tomato_openvz', 'next_sync', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'KVMQM.rextfv_last_started'
        db.alter_column('tomato_kvmqm', 'rextfv_last_started', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'KVMQM.next_sync'
        db.alter_column('tomato_kvmqm', 'next_sync', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Repy.rextfv_last_started'
        db.alter_column('tomato_repy', 'rextfv_last_started', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Repy.next_sync'
        db.alter_column('tomato_repy', 'next_sync', self.gf('django.db.models.fields.FloatField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'OpenVZ.rextfv_last_started'
        db.alter_column('tomato_openvz', 'rextfv_last_started', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'OpenVZ.next_sync'
        db.alter_column('tomato_openvz', 'next_sync', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'KVMQM.rextfv_last_started'
        db.alter_column('tomato_kvmqm', 'rextfv_last_started', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'KVMQM.next_sync'
        db.alter_column('tomato_kvmqm', 'next_sync', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Repy.rextfv_last_started'
        db.alter_column('tomato_repy', 'rextfv_last_started', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Repy.next_sync'
        db.alter_column('tomato_repy', 'next_sync', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'tomato.kvmqm': {
            ...
            'element': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tomato.HostElement']", 'null': 'True'}),
            'element_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['tomato.Element']", 'unique': 'True', 'primary_key': 'True'}),
            'next_sync': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1373962868.792609'}),
