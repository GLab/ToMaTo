...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SpecialFeatureConnector.used_feature_group'
        db.add_column('tomato_specialfeatureconnector', 'used_feature_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tomato.SpecialFeatureGroup'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SpecialFeatureConnector.used_feature_group'
        db.delete_column('tomato_specialfeatureconnector', 'used_feature_group_id')
