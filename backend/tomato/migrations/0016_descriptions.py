...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tomato_element', 'connection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['tomato.Connection']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Element.connection'
        db.alter_column('tomato_element', 'connection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tomato.Connection']))
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1386943258.729027'}),
