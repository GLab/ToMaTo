...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenVZ.rextfv_last_started'
        db.add_column('tomato_openvz', 'rextfv_last_started', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'OpenVZ.next_sync'
        db.add_column('tomato_openvz', 'next_sync', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'TemplateOnHost.ready'
        db.alter_column('tomato_templateonhost', 'ready', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Adding field 'KVMQM.rextfv_last_started'
        db.add_column('tomato_kvmqm', 'rextfv_last_started', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'KVMQM.next_sync'
        db.add_column('tomato_kvmqm', 'next_sync', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Repy.rextfv_last_started'
        db.add_column('tomato_repy', 'rextfv_last_started', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Repy.next_sync'
        db.add_column('tomato_repy', 'next_sync', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'OpenVZ.rextfv_last_started'
        db.delete_column('tomato_openvz', 'rextfv_last_started')

        # Deleting field 'OpenVZ.next_sync'
        db.delete_column('tomato_openvz', 'next_sync')

        # Changing field 'TemplateOnHost.ready'
        db.alter_column('tomato_templateonhost', 'ready', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'KVMQM.rextfv_last_started'
        db.delete_column('tomato_kvmqm', 'rextfv_last_started')

        # Deleting field 'KVMQM.next_sync'
        db.delete_column('tomato_kvmqm', 'next_sync')

        # Deleting field 'Repy.rextfv_last_started'
        db.delete_column('tomato_repy', 'rextfv_last_started')

        # Deleting field 'Repy.next_sync'
        db.delete_column('tomato_repy', 'next_sync')
    ...
    models = {
        ...
        'tomato.kvmqm': {
            ...
            'element': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tomato.HostElement']", 'null': 'True'}),
            'element_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['tomato.Element']", 'unique': 'True', 'primary_key': 'True'}),
            'next_sync': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tomato.Profile']", 'null': 'True'}),
            'rextfv_last_started': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1373879553.400815'}),
