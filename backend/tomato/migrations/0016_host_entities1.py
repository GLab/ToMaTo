...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HostElement.topology_element'
        db.add_column('tomato_hostelement', 'topology_element', self.gf('django.db.models.fields.related.ForeignKey')(related_name='host_elements', null=True, to=orm['tomato.Element']), keep_default=False)

        # Adding field 'HostElement.topology_connection'
        db.add_column('tomato_hostelement', 'topology_connection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='host_elements', null=True, to=orm['tomato.Connection']), keep_default=False)

        # Adding field 'HostConnection.topology_element'
        db.add_column('tomato_hostconnection', 'topology_element', self.gf('django.db.models.fields.related.ForeignKey')(related_name='host_connections', null=True, to=orm['tomato.Element']), keep_default=False)

        # Adding field 'HostConnection.topology_connection'
        db.add_column('tomato_hostconnection', 'topology_connection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='host_connections', null=True, to=orm['tomato.Connection']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HostElement.topology_element'
        db.delete_column('tomato_hostelement', 'topology_element_id')

        # Deleting field 'HostElement.topology_connection'
        db.delete_column('tomato_hostelement', 'topology_connection_id')

        # Deleting field 'HostConnection.topology_element'
        db.delete_column('tomato_hostconnection', 'topology_element_id')

        # Deleting field 'HostConnection.topology_connection'
        db.delete_column('tomato_hostconnection', 'topology_connection_id')
    ...
    models = {
        ...
        'tomato.user': {
            ...
            'attrs': ('tomato.lib.db.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.FloatField', [], {'default': '1389176720.047275'}),
