...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tomato_tincconnector', 'mode', self.gf('django.db.models.fields.CharField')(default='switch', max_length=10), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TincConnector.mode'
        db.delete_column('tomato_tincconnector', 'mode')
