...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('glabnetman_resources', (
            ('ports', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('public_ips', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('glabnetman', ['Resources'])

        # Adding field 'Topology.resources'
        db.add_column('glabnetman_topology', 'resources', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glabnetman.Resources'], null=True), keep_default=False)

        # Adding field 'Device.resources'
        db.add_column('glabnetman_device', 'resources', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glabnetman.Resources'], null=True), keep_default=False)

        # Adding field 'Connector.resources'
        db.add_column('glabnetman_connector', 'resources', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glabnetman.Resources'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'Resources'
        db.delete_table('glabnetman_resources')

        # Deleting field 'Topology.resources'
        db.delete_column('glabnetman_topology', 'resources_id')

        # Deleting field 'Device.resources'
        db.delete_column('glabnetman_device', 'resources_id')

        # Deleting field 'Connector.resources'
        db.delete_column('glabnetman_connector', 'resources_id')
    ...
    models = {
        ...
        'glabnetman.internetconnector': {
            'Meta': {'object_name': 'InternetConnector', '_ormbases': ['glabnetman.Connector']},
        ...
        'glabnetman.resources': {
            ...
            'public_ips': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'glabnetman.template': {
