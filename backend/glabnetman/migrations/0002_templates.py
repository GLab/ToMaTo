...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('glabnetman_template', (
            ('id', orm['glabnetman.template:id']),
            ('name', orm['glabnetman.template:name']),
            ('type', orm['glabnetman.template:type']),
        ))
        db.send_create_signal('glabnetman', ['Template'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('glabnetman_template')
