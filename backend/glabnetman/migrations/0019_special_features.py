...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('glabnetman_specialfeature', (
            ('bridge', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glabnetman.Host'])),
        ...
        db.send_create_signal('glabnetman', ['SpecialFeature'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'SpecialFeature'
        db.delete_table('glabnetman_specialfeature')
