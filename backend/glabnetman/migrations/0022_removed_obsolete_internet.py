...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Host.public_bridge'
        db.delete_column('glabnetman_host', 'public_bridge')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Host.public_bridge'
        db.add_column('glabnetman_host', 'public_bridge', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)
