...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Error'
        db.create_table('glabnetman_error', (
            ('id', orm['glabnetman.error:id']),
            ('date', orm['glabnetman.error:date']),
            ('title', orm['glabnetman.error:title']),
            ('message', orm['glabnetman.error:message']),
        ))
        db.send_create_signal('glabnetman', ['Error'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('glabnetman_error')
