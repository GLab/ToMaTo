...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('glabnetman_physicallink', (
            ('loss', self.gf('django.db.models.fields.FloatField')()),
            ('dst_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reverselink', to=orm['glabnetman.HostGroup'])),
            ('src_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glabnetman.HostGroup'])),
            ('delay_avg', self.gf('django.db.models.fields.FloatField')()),
            ('delay_stddev', self.gf('django.db.models.fields.FloatField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('glabnetman', ['PhysicalLink'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'PhysicalLink'
        db.delete_table('glabnetman_physicallink')
