...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Device.host'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['glabnetman.Host'], null=True))
        db.alter_column('glabnetman_device', 'host_id', orm['glabnetman.device:host'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Device.host'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['glabnetman.Host']))
        db.alter_column('glabnetman_device', 'host_id', orm['glabnetman.device:host'])
