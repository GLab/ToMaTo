...
class Migration:
    ...
    def forwards(self, orm):
        ...
        import datetime
        db.add_column('glabnetman_topology', 'date_usage', models.DateTimeField(default=datetime.datetime.now()), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('glabnetman_topology', 'date_usage')
