...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('glabnetman_specialfeatureconnector', (
            ...
            ('connector_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['glabnetman.Connector'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('glabnetman', ['SpecialFeatureConnector'])

        # Changing field 'Connection.bridge_special_name'
        db.alter_column('glabnetman_connection', 'bridge_special_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    
    
    def backwards(self, orm):
        
        # Deleting model 'SpecialFeatureConnector'
        db.delete_table('glabnetman_specialfeatureconnector')

        # Changing field 'Connection.bridge_special_name'
        db.alter_column('glabnetman_connection', 'bridge_special_name', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    ...
    models = {
        ...
        'glabnetman.connection': {
            ...
            'bridge_special_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
