...
class Test(unittest.TestCase):
	...
	def testHosts(self):
		...
		api.host_add("host1a", "group1", True, {}, user=admin)
		api.host_add("host1b", "group1", True, {}, user=admin)
		api.host_add("host2a", "group2", True, {}, user=admin)
		api.host_add("host2b", "group2", True, {}, user=admin)
		api.host_add("host2c", "group2", True, {}, user=admin)
		tests.wait_for_tasks(api, admin)
